...
public class AboutController : Controller
{
    public IActionResult Index()
    {
        var model = new AboutPageViewModel
        {
            ...
            Subtitle = "NorthStar English định hướng đào tạo chuẩn đầu ra và quản trị minh bạch.",
            ...
            CoreValues = ["Lấy trải nghiệm học viên làm trọng tâm", "Quản trị lớp học minh bạch và kịp thời", "Tối ưu quy trình tuyển sinh - ghi danh - học phí", "Sẵn sàng tích hợp dữ liệu thật sau giai đoạn demo UI"],
            Advantages = ["Lộ trình học rõ ràng theo đầu ra", "Báo cáo tiến độ cho giáo vụ và giáo viên", "Quản lý học phí, công nợ, biên nhận trên cùng hệ thống", "Dễ mở rộng thêm phân hệ khảo thí và CRM sau này"]
        };
